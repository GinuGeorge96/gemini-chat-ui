            ...
            <div className="main-container">
                {
                    !showResult ? <> <div className="greet">
                        ...
                        <div className="cards">
                            <div className="card"  onClick={() => onSent("Suggest beautiful places to see on upcoming trips")}>
                                <p>Suggest beautiful places to see on upcoming trips</p>
                                <img src={assets.compass_icon} alt="" />
                            </div>
                            <div className="card"  onClick={() => onSent("Brainstorm team bonding activities")}>
                ...
                <div className="main-bottom">
                    <div className="search-box">
                        <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder='Enter your prommpt here' />
                        <div>
                    ...
                    <p className={`bottom-info ${!showResult ? "hidden-text" : ""}`}>
                        Gemini can make mistakes, including about people, so double-check it.
                        <a href='#'> Your privacy and Gemini</a>
                    </p>
                </div>
            </div>
        </div>
